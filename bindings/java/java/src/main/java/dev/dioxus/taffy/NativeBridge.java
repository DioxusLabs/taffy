...
final class NativeBridge {
    ...
    static native void styleSetGridTemplateColumns(long handle, int[] tags, float[] values);
    static native void styleSetGridTemplateRows(long handle, int[] tags, float[] values);
    static native void styleSetGridAutoColumns(long handle, int[] tags, float[] values);
    static native void styleSetGridAutoRows(long handle, int[] tags, float[] values);
    static native void styleSetGridColumn(long handle,
                                          int startTag, float startVal,
                                          int endTag,   float endVal);
