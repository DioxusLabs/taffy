...
pub fn f32_from_object<'local>(env: &mut JNIEnv<'local>, value: JValueOwned<'local>, def: fn() -> f32) -> f32 {
    ...
    env
        .call_method(object, "floatValue", "()F", &[])
        .unwrap()
        .f()
        .unwrap() as f32
}
...
pub fn opt_f32_from_object<'local>(env: &mut JNIEnv<'local>, value: JValueOwned<'local>, def: fn() -> Option<f32>) -> Option<f32> {
    let object = value.l().unwrap();
...
pub fn i8_from_object<'local>(env: &mut JNIEnv<'local>, value: JValueOwned<'local>, def: fn() -> i8) -> i8 {
    ...
    env
        .call_method(object, "byteValue", "()B", &[])
        .unwrap()
        .b()
        .unwrap() as i8
}
...
pub fn i16_from_object<'local>(env: &mut JNIEnv<'local>, value: JValueOwned<'local>, def: fn() -> i16) -> i16 {
    ...
    env
        .call_method(object, "shortValue", "()S", &[])
        .unwrap()
        .s()
        .unwrap() as i16
}
...
pub fn i64_from_object<'local>(env: &mut JNIEnv<'local>, value: JValueOwned<'local>, def: fn() -> i64) -> i64 {
    ...
    env
        .call_method(object, "longValue", "()J", &[])
        .unwrap()
        .j()
        .unwrap() as i64
}
...
#[allow(dead_code)]
pub fn opt_bool_from_object<'local>(env: &mut JNIEnv<'local>, value: JValueOwned<'local>, def: fn() -> Option<bool>) -> Option<bool> {
    let object = value.l().unwrap();
...
pub fn opt_node_id_from_object<'local>(env: &mut JNIEnv<'local>, value: JValueOwned<'local>) -> Option<NodeId> {
    ...
    if o.is_none() { None } else { Some(NodeId::from(o? as u64)) }
}

/// Convert Java float to f32, using a field name
pub fn f_f32_from_primitive<'local>(env: &mut JNIEnv<'local>, base: &JObject<'local>, field: &str, def: fn() -> f32) -> f32 {
...
/// Convert Java float to f32, using a field name
pub fn f_opt_f32_from_object<'local>(env: &mut JNIEnv<'local>, base: &JObject<'local>, field: &str, def: fn() -> Option<f32>) -> Option<f32> {
...
pub fn f_i8_from_primitive<'local>(env: &mut JNIEnv<'local>, base: &JObject<'local>, field: &str, def: fn() -> i8) -> i8 {
...
pub fn f_i16_from_primitive<'local>(env: &mut JNIEnv<'local>, base: &JObject<'local>, field: &str, def: fn() -> i16) -> i16 {
    let value = f_get_value(env, base, field, "B");
...
pub fn f_i32_from_primitive<'local>(env: &mut JNIEnv<'local>, base: &JObject<'local>, field: &str, def: fn() -> i32) -> i32 {
...
#[allow(dead_code)]
pub fn f_i64_from_primitive<'local>(env: &mut JNIEnv<'local>, base: &JObject<'local>, field: &str, def: fn() -> i64) -> i64 {
...
pub fn f_bool_from_primitive<'local>(env: &mut JNIEnv<'local>, base: &JObject<'local>, field: &str, def: fn() -> bool) -> bool {
