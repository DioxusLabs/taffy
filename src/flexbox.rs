...
impl Taffy {
    ...
    fn determine_flex_base_size(
        ...
        for child in flex_items {
            ...
            let min_main = self
                .compute_preliminary(child.node, Size::<Option<f32>>::NONE, available_space, false, false)
                .main(constants.dir)
        ...
        loop {
            ...
            let total_violation = unfrozen.iter_mut().fold(0.0, |acc, child| -> f32 {
                ...
                let min_main = if constants.is_row && self.nodes[child.node].measure.is_none() {
                    self.compute_preliminary(child.node, Size::<Option<f32>>::NONE, available_space, false, false)
                        .width
...
mod tests {
    ...
    fn correct_constants() {
        ...
        let node_size = Size::<Option<f32>>::NONE;
        let parent_size = Size::<Option<f32>>::NONE;
