...
use crate::tree::{
    ...
    SizingMode, StaticEdge, StaticPosition,
};
            ...
            if !container_position.is_positioned() {
                ...
                fn static_position_for_axis(
                    ...
                    if matches!(alignment.safety, crate::style::AlignmentSafety::Safe) {
                        let (fallback_anchor, fallback_edge) = anchor_for(
                            crate::compute::common::alignment::resolve_self_alignment_safety(alignment, true),
                        );
                        StaticPosition {
                            anchor,
                            edge,
