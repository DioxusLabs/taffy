...
mod generated {
    ...
    fn wrap_reverse_row() {
        let layout = stretch::compute(&stretch::style::Node {
            ...
            children: vec![
                stretch::style::Node {
                    width: stretch::style::Dimension::Points(31.0),
                    height: stretch::style::Dimension::Points(30.0),
                    ..Default::default()
                },
                stretch::style::Node {
                    width: stretch::style::Dimension::Points(32.0),
                    height: stretch::style::Dimension::Points(30.0),
                    ..Default::default()
                },
                stretch::style::Node {
                    width: stretch::style::Dimension::Points(33.0),
                    height: stretch::style::Dimension::Points(30.0),
                    ..Default::default()
                },
                stretch::style::Node {
                    width: stretch::style::Dimension::Points(34.0),
                    height: stretch::style::Dimension::Points(30.0),
                    ..Default::default()
                },
            ],
    ...
    fn wrap_reverse_column() {
        let layout = stretch::compute(&stretch::style::Node {
            ...
            children: vec![
                stretch::style::Node {
                    width: stretch::style::Dimension::Points(30.0),
                    height: stretch::style::Dimension::Points(31.0),
                    ..Default::default()
                },
                stretch::style::Node {
                    width: stretch::style::Dimension::Points(30.0),
                ...
                stretch::style::Node {
                    width: stretch::style::Dimension::Points(30.0),
                    height: stretch::style::Dimension::Points(33.0),
                    ..Default::default()
                },
                stretch::style::Node {
                    width: stretch::style::Dimension::Points(30.0),
                    height: stretch::style::Dimension::Points(34.0),
                    ..Default::default()
                },
            ],
            ..Default::default()
        ...
        assert_eq!(layout.children[0].width, 30.0);
        assert_eq!(layout.children[0].height, 31.0);
        assert_eq!(layout.children[0].x, 70.0);
        assert_eq!(layout.children[0].y, 0.0);

        assert_eq!(layout.children[1].width, 30.0);
        assert_eq!(layout.children[1].height, 32.0);
        assert_eq!(layout.children[1].x, 70.0);
        assert_eq!(layout.children[1].y, 31.0);

        assert_eq!(layout.children[2].width, 30.0);
        assert_eq!(layout.children[2].height, 33.0);
        assert_eq!(layout.children[2].x, 70.0);
        assert_eq!(layout.children[2].y, 63.0);

        assert_eq!(layout.children[3].width, 30.0);
        assert_eq!(layout.children[3].height, 34.0);
