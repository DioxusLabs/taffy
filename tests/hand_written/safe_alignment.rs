    ...
    let root = taffy
        .new_with_children(
            Style {
                ...
                grid_template_rows: thin_vec![length(100.0)],
                grid_template_columns: thin_vec![length(100.0)],
                ..Default::default()
            },
            &[child],
        )
    ...
    let root = taffy
        .new_with_children(
            Style {
                display: Display::Grid,
                size: Size { width: length(100.0), height: length(100.0) },
                grid_template_rows: thin_vec![length(80.0), length(80.0)],
                grid_template_columns: thin_vec![length(40.0)],
