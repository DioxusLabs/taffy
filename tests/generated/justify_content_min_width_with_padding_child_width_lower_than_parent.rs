...
fn justify_content_min_width_with_padding_child_width_lower_than_parent() {
    ...
    assert_eq!(stretch.layout(node).size.width, 1080f32);
    assert_eq!(stretch.layout(node).size.height, 1584f32);
    assert_eq!(stretch.layout(node).location.x, 0f32);
    assert_eq!(stretch.layout(node).location.y, 0f32);
    assert_eq!(stretch.layout(node0).size.width, 1080f32);
    ...
    assert_eq!(stretch.layout(node00).size.width, 400f32);
    ...
    assert_eq!(stretch.layout(node000).size.width, 199f32);
    assert_eq!(stretch.layout(node000).size.height, 100f32);
    assert_eq!(stretch.layout(node000).location.x, 101f32);
