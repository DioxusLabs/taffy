...
fn rounding_flex_basis_flex_grow_row_width_of_100() {
    ...
    assert_eq!(stretch.layout(node0).size.width, 33f32);
    ...
    assert_eq!(stretch.layout(node1).size.width, 34f32);
    assert_eq!(stretch.layout(node1).size.height, 100f32);
    assert_eq!(stretch.layout(node1).location.x, 33f32);
    ...
    assert_eq!(stretch.layout(node2).location.x, 67f32);
