...
fn android_news_feed() {
    ...
    let node000000 = taffy.new_leaf(taffy::style::Style {
    ...
    let node00000 = taffy.new_with_children(
        taffy::style::Style {
            align_content: Some(taffy::style::AlignContent::Stretch),
            flex_shrink: 0f32,
            ..Default::default()
    ...
    let node000010 = taffy.new_leaf(taffy::style::Style {
        align_content: Some(taffy::style::AlignContent::Stretch),
        flex_shrink: 1f32,
        ..Default::default()
    });
    let node000011 = taffy.new_leaf(taffy::style::Style {
        align_content: Some(taffy::style::AlignContent::Stretch),
        flex_shrink: 1f32,
        ..Default::default()
    });
    let node00001 = taffy.new_with_children(
        taffy::style::Style {
    ...
    let node0000 = taffy.new_with_children(
        taffy::style::Style {
    ...
    let node001000 = taffy.new_leaf(taffy::style::Style {
        align_content: Some(taffy::style::AlignContent::Stretch),
        flex_shrink: 0f32,
        size: taffy::geometry::Size {
    ...
    let node00100 = taffy.new_with_children(
        taffy::style::Style {
            align_content: Some(taffy::style::AlignContent::Stretch),
            flex_shrink: 0f32,
            ..Default::default()
    ...
    let node001010 = taffy.new_leaf(taffy::style::Style {
        align_content: Some(taffy::style::AlignContent::Stretch),
        flex_shrink: 1f32,
        ..Default::default()
    });
    let node001011 = taffy.new_leaf(taffy::style::Style {
        align_content: Some(taffy::style::AlignContent::Stretch),
        flex_shrink: 1f32,
        ..Default::default()
    });
    let node00101 = taffy.new_with_children(
        taffy::style::Style {
            flex_direction: taffy::style::FlexDirection::Column,
            align_content: Some(taffy::style::AlignContent::Stretch),
            flex_shrink: 1f32,
    ...
    let node0010 = taffy.new_with_children(
        taffy::style::Style {
            align_items: Some(taffy::style::AlignItems::FlexStart),
            align_content: Some(taffy::style::AlignContent::Stretch),
            margin: taffy::geometry::Rect {
    ...
    let Layout { size, location, .. } = taffy.layout(node0000);
    ...
    let Layout { size, location, .. } = taffy.layout(node00000);
    ...
    let Layout { size, location, .. } = taffy.layout(node000000);
    ...
    let Layout { size, location, .. } = taffy.layout(node00001);
    ...
    let Layout { size, location, .. } = taffy.layout(node000010);
    ...
    let Layout { size, location, .. } = taffy.layout(node000011);
    ...
    let Layout { size, location, .. } = taffy.layout(node0010);
    ...
    let Layout { size, location, .. } = taffy.layout(node00100);
    ...
    let Layout { size, location, .. } = taffy.layout(node001000);
    ...
    let Layout { size, location, .. } = taffy.layout(node00101);
    ...
    let Layout { size, location, .. } = taffy.layout(node001010);
    ...
    let Layout { size, location, .. } = taffy.layout(node001011);
