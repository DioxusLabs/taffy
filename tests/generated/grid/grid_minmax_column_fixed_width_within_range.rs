...
fn grid_minmax_column_fixed_width_within_range__border_box() {
    ...
    if layout.location.x != 70f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node5, stringify!(location.x), 70f32, layout.location.x);
    }
    if layout.location.y != 40f32 {
        mismatches += 1;
    ...
    if layout.location.x != 70f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node8, stringify!(location.x), 70f32, layout.location.x);
    }
    if layout.location.y != 80f32 {
        mismatches += 1;
