...
fn grid_span_6_all_non_flex_indefinite_hidden__border_box() {
    ...
    if layout.size.width != 19f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(size.width), 19f32, layout.size.width);
    }
    if layout.size.height != 40f32 {
        mismatches += 1;
    ...
    if layout.size.width != 99f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(size.width), 99f32, layout.size.width);
    }
    if layout.size.height != 40f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(size.height), 40f32, layout.size.height);
    }
    if layout.location.x != 19f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(location.x), 19f32, layout.location.x);
    }
    if layout.location.y != 40f32 {
        mismatches += 1;
    ...
    if layout.location.x != 118f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node3, stringify!(location.x), 118f32, layout.location.x);
    }
    if layout.location.y != 40f32 {
        mismatches += 1;
    ...
    if layout.location.x != 118f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node4, stringify!(location.x), 118f32, layout.location.x);
    }
    if layout.location.y != 40f32 {
        mismatches += 1;
