...
fn grid_justify_content_end_with_padding_border__border_box() {
    ...
    if layout.location.x != 56f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(location.x), 56f32, layout.location.x);
    }
    ...
    if layout.location.x != 96f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(location.x), 96f32, layout.location.x);
    }
    if layout.location.y != 12f32 {
        mismatches += 1;
    ...
    if layout.location.x != 56f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node3, stringify!(location.x), 56f32, layout.location.x);
    }
    ...
    if layout.location.x != 96f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node4, stringify!(location.x), 96f32, layout.location.x);
    }
    if layout.location.y != 52f32 {
        mismatches += 1;
    ...
    if layout.location.x != 56f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node6, stringify!(location.x), 56f32, layout.location.x);
    }
    ...
    if layout.location.x != 96f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node7, stringify!(location.x), 96f32, layout.location.x);
    }
    if layout.location.y != 92f32 {
        mismatches += 1;
...
fn grid_justify_content_end_with_padding_border__content_box() {
    ...
    if layout.location.x != 128f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(location.x), 128f32, layout.location.x);
    }
    if layout.location.y != 12f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(location.y), 12f32, layout.location.y);
    ...
    if layout.location.x != 168f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(location.x), 168f32, layout.location.x);
    }
    if layout.location.y != 12f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(location.y), 12f32, layout.location.y);
    ...
    if layout.location.x != 128f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node3, stringify!(location.x), 128f32, layout.location.x);
    }
    if layout.location.y != 52f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node3, stringify!(location.y), 52f32, layout.location.y);
    ...
    if layout.location.x != 168f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node4, stringify!(location.x), 168f32, layout.location.x);
    }
    if layout.location.y != 52f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node4, stringify!(location.y), 52f32, layout.location.y);
    ...
    if layout.location.x != 168f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node7, stringify!(location.x), 168f32, layout.location.x);
    }
    if layout.location.y != 92f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node7, stringify!(location.y), 92f32, layout.location.y);
