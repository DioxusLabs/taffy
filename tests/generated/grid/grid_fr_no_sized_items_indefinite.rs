...
fn grid_fr_no_sized_items_indefinite__border_box() {
    ...
    if layout.size.width != 0f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(size.width), 0f32, layout.size.width);
    }
    if layout.size.height != 40f32 {
        mismatches += 1;
    ...
    if layout.size.width != 0f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node5, stringify!(size.width), 0f32, layout.size.width);
    }
    if layout.size.height != 0f32 {
        mismatches += 1;
    ...
    if layout.size.width != 0f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node7, stringify!(size.width), 0f32, layout.size.width);
    }
    if layout.size.height != 0f32 {
        mismatches += 1;
    ...
    if layout.size.width != 0f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node8, stringify!(size.width), 0f32, layout.size.width);
    }
    if layout.size.height != 0f32 {
        mismatches += 1;
