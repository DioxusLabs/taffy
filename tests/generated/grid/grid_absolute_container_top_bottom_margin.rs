...
fn grid_absolute_container_top_bottom_margin__border_box() {
    ...
    let node0 = taffy
        .new_leaf(taffy::style::Style {
            ...
            inset: taffy::geometry::Rect { left: auto(), right: auto(), top: length(2f32), bottom: length(5f32) },
            ..Default::default()
        })
        .unwrap();
    let node1 = taffy
    ...
    if layout.location.x != 4f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(location.x), 4f32, layout.location.x);
    }
    if layout.location.y != 3f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(location.y), 3f32, layout.location.y);
    }
    #[cfg(feature = "content_size")]
    if layout.scroll_width() != 0f32 {
        mismatches += 1;
    ...
    if layout.location.x != 120f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node3, stringify!(location.x), 120f32, layout.location.x);
    }
    if layout.location.y != 10f32 {
        mismatches += 1;
    ...
    if layout.location.y != 50f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node4, stringify!(location.y), 50f32, layout.location.y);
    }
    #[cfg(feature = "content_size")]
    if layout.scroll_width() != 0f32 {
        mismatches += 1;
    ...
    if layout.location.x != 120f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node6, stringify!(location.x), 120f32, layout.location.x);
    }
    if layout.location.y != 50f32 {
        mismatches += 1;
    ...
    if layout.location.y != 90f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node7, stringify!(location.y), 90f32, layout.location.y);
    }
    #[cfg(feature = "content_size")]
    if layout.scroll_width() != 0f32 {
        mismatches += 1;
