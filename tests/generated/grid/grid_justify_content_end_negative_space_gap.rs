...
fn grid_justify_content_end_negative_space_gap__border_box() {
    ...
    if layout.location.x != 30f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node04, stringify!(location.x), 30f32, layout.location.x);
    }
    if layout.location.y != 50f32 {
        mismatches += 1;
    ...
    if layout.location.x != 30f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node07, stringify!(location.x), 30f32, layout.location.x);
    }
    if layout.location.y != 80f32 {
        mismatches += 1;
