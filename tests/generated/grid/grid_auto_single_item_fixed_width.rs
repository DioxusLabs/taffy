...
fn grid_auto_single_item_fixed_width__border_box() {
    ...
    if layout.location.x != 170f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(location.x), 170f32, layout.location.x);
    }
    if layout.location.y != 0f32 {
        mismatches += 1;
    ...
    if layout.size.width != 130f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node4, stringify!(size.width), 130f32, layout.size.width);
    }
    if layout.size.height != 40f32 {
        mismatches += 1;
    ...
    if layout.size.width != 30f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node5, stringify!(size.width), 30f32, layout.size.width);
    }
    if layout.size.height != 40f32 {
        mismatches += 1;
    ...
    if layout.location.x != 170f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node5, stringify!(location.x), 170f32, layout.location.x);
    }
    if layout.location.y != 40f32 {
        mismatches += 1;
    ...
    if layout.size.width != 130f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node7, stringify!(size.width), 130f32, layout.size.width);
    }
    if layout.size.height != 40f32 {
        mismatches += 1;
    ...
    if layout.size.width != 30f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node8, stringify!(size.width), 30f32, layout.size.width);
    }
    if layout.size.height != 40f32 {
        mismatches += 1;
    ...
    if layout.location.x != 170f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node8, stringify!(location.x), 170f32, layout.location.x);
    }
    if layout.location.y != 80f32 {
        mismatches += 1;
