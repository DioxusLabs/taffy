...
fn grid_max_width_greater_than_max_content() {
    ...
    let node0 = taffy
        .new_with_children(
            taffy::style::Style {
                ...
                max_size: taffy::geometry::Size { width: taffy::style::Dimension::Points(400f32), height: auto() },
                ..Default::default()
            },
            &[node00, node01],
        )
    ...
    assert_eq!(location.x, 80f32, "x of node {:?}. Expected {}. Actual {}", node01.data(), 80f32, location.x);
