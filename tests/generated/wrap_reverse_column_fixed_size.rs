...
fn wrap_reverse_column_fixed_size() {
    ...
    assert_eq!(stretch.layout(node0).location.x, 135f32);
    ...
    assert_eq!(stretch.layout(node1).location.x, 135f32);
    assert_eq!(stretch.layout(node1).location.y, 10f32);
    assert_eq!(stretch.layout(node2).size.width, 30f32);
    assert_eq!(stretch.layout(node2).size.height, 30f32);
    assert_eq!(stretch.layout(node2).location.x, 135f32);
    assert_eq!(stretch.layout(node2).location.y, 30f32);
    assert_eq!(stretch.layout(node3).size.width, 30f32);
    assert_eq!(stretch.layout(node3).size.height, 40f32);
    assert_eq!(stretch.layout(node3).location.x, 135f32);
    assert_eq!(stretch.layout(node3).location.y, 60f32);
    assert_eq!(stretch.layout(node4).size.width, 30f32);
    assert_eq!(stretch.layout(node4).size.height, 50f32);
    assert_eq!(stretch.layout(node4).location.x, 35f32);
