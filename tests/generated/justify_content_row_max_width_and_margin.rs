...
fn justify_content_row_max_width_and_margin() {
    ...
    let node0 = stretch.new_node(
        stretch::style::Style {
            ...
            margin: stretch::geometry::Rect { start: stretch::style::Dimension::Points(100f32), ..Default::default() },
            ..Default::default()
        },
        vec![],
    );
    ...
    assert_eq!(stretch.layout(node).size.width, 80f32);
    ...
    assert_eq!(stretch.layout(node0).location.x, 90f32);
