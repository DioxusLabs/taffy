...
fn grid_justify_content_end_negative_space_gap() {
    ...
    assert_eq!(location.x, 30f32, "x of node {:?}. Expected {}. Actual {}", node04.data(), 30f32, location.x);
    ...
    assert_eq!(location.x, 30f32, "x of node {:?}. Expected {}. Actual {}", node07.data(), 30f32, location.x);
