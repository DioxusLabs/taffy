...
fn percentage_flex_basis_cross_max_width() {
    ...
    let node0 = taffy.new_with_children(
        taffy::style::FlexboxLayout {
            ...
            max_size: taffy::geometry::Size { width: taffy::style::Dimension::Percent(0.6f32), ..Default::default() },
            ..Default::default()
        },
        &[],
    );
    let node1 = taffy.new_with_children(
        taffy::style::FlexboxLayout {
            ...
            max_size: taffy::geometry::Size { width: taffy::style::Dimension::Percent(0.2f32), ..Default::default() },
            ..Default::default()
        },
        &[],
    );
