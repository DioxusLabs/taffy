...
fn wrap_column() {
        ...
        .new_node(
            stretch2::style::Style {
                size: stretch2::geometry::Size {
                    ...
                    height: stretch2::style::Dimension::Points(31f32),
                    ..Default::default()
                },
                ..Default::default()
            },
    ...
    let node1 = stretch
        .new_node(
            stretch2::style::Style {
                size: stretch2::geometry::Size {
                    width: stretch2::style::Dimension::Points(30f32),
                    height: stretch2::style::Dimension::Points(32f32),
                    ..Default::default()
                },
                ..Default::default()
            },
    ...
    let node2 = stretch
        .new_node(
            stretch2::style::Style {
                size: stretch2::geometry::Size {
                    width: stretch2::style::Dimension::Points(30f32),
                    height: stretch2::style::Dimension::Points(33f32),
                    ..Default::default()
                },
                ..Default::default()
            },
    ...
    let node3 = stretch
        .new_node(
            stretch2::style::Style {
                size: stretch2::geometry::Size {
                    width: stretch2::style::Dimension::Points(30f32),
                    height: stretch2::style::Dimension::Points(34f32),
                    ..Default::default()
                },
                ..Default::default()
            },
    ...
    assert_eq!(stretch.layout(node3).unwrap().location.x, 50f32);
