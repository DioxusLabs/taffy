...
fn bevy_issue_7976_4_level__border_box() {
    ...
    if layout.size.width != 30f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node00, stringify!(size.width), 30f32, layout.size.width);
    }
    ...
    if layout.location.x != 5f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node00, stringify!(location.x), 5f32, layout.location.x);
    }
    if layout.location.y != 5f32 {
        mismatches += 1;
    ...
    if layout.location.x != 5f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node000, stringify!(location.x), 5f32, layout.location.x);
    }
    if layout.location.y != 5f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node000, stringify!(location.y), 5f32, layout.location.y);
    }
    #[cfg(feature = "content_size")]
    if layout.scroll_width() != 0f32 {
        mismatches += 1;
