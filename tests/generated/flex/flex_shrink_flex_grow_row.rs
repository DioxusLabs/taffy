...
fn flex_shrink_flex_grow_row__border_box() {
    ...
    if layout.size.width != 250f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(size.width), 250f32, layout.size.width);
    }
    ...
    if layout.size.width != 250f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(size.width), 250f32, layout.size.width);
    }
    if layout.size.height != 100f32 {
        mismatches += 1;
        eprintln!(
