...
fn align_content_not_stretch_with_align_items_stretch__border_box() {
    ...
    if layout.size.width != 328f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node, stringify!(size.width), 328f32, layout.size.width);
    }
    if layout.size.height != 52f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node, stringify!(size.height), 52f32, layout.size.height);
    }
    ...
    if layout.size.width != 272f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(size.width), 272f32, layout.size.width);
    }
    if layout.size.height != 44f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(size.height), 44f32, layout.size.height);
    }
    if layout.location.x != 0f32 {
        mismatches += 1;
    ...
    if layout.size.width != 272f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node00, stringify!(size.width), 272f32, layout.size.width);
    }
    if layout.size.height != 44f32 {
        mismatches += 1;
        eprintln!(
    ...
    if layout.size.width != 56f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(size.width), 56f32, layout.size.width);
    }
    if layout.size.height != 44f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(size.height), 44f32, layout.size.height);
    }
    if layout.location.x != 272f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(location.x), 272f32, layout.location.x);
    }
    if layout.location.y != 0f32 {
        mismatches += 1;
    ...
    if layout.size.width != 56f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node10, stringify!(size.width), 56f32, layout.size.width);
    }
    if layout.size.height != 44f32 {
        mismatches += 1;
        eprintln!(
