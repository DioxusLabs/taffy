...
fn rounding_fractial_input_2__border_box() {
        ...
        .new_with_children(
            taffy::style::Style {
                ...
                size: taffy::geometry::Size {
                    ...
                    height: taffy::style::Dimension::from_length(113.6f32),
                },
                ..Default::default()
            },
            &[node0, node1, node2],
    ...
    if layout.size.height != 114f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node, stringify!(size.height), 114f32, layout.size.height);
    }
    ...
    if layout.size.height != 65f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(size.height), 65f32, layout.size.height);
    }
    if layout.location.x != 0f32 {
        mismatches += 1;
    ...
    if layout.size.height != 24f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(size.height), 24f32, layout.size.height);
    }
    if layout.location.x != 0f32 {
        mismatches += 1;
    ...
    if layout.location.y != 65f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(location.y), 65f32, layout.location.y);
    }
    #[cfg(feature = "content_size")]
    if layout.scroll_width() != 0f32 {
        mismatches += 1;
    ...
    if layout.size.height != 25f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(size.height), 25f32, layout.size.height);
    }
    if layout.location.x != 0f32 {
        mismatches += 1;
