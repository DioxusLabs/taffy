...
fn rounding_inner_node_controversy_horizontal__border_box() {
    ...
    if layout.size.width != 107f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(size.width), 107f32, layout.size.width);
    }
    if layout.size.height != 10f32 {
        mismatches += 1;
    ...
    if layout.size.width != 106f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(size.width), 106f32, layout.size.width);
    }
    if layout.size.height != 10f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(size.height), 10f32, layout.size.height);
    }
    if layout.location.x != 107f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(location.x), 107f32, layout.location.x);
    }
    if layout.location.y != 0f32 {
        mismatches += 1;
    ...
    if layout.size.width != 106f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node10, stringify!(size.width), 106f32, layout.size.width);
    }
    if layout.size.height != 10f32 {
        mismatches += 1;
        eprintln!(
    ...
    if layout.size.width != 107f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(size.width), 107f32, layout.size.width);
    }
    if layout.size.height != 10f32 {
        mismatches += 1;
    ...
    if layout.location.x != 213f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(location.x), 213f32, layout.location.x);
    }
    if layout.location.y != 0f32 {
        mismatches += 1;
