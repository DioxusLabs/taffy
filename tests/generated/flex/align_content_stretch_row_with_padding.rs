...
fn align_content_stretch_row_with_padding__content_box() {
    ...
    if layout.size.width != 70f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(size.width), 70f32, layout.size.width);
    }
    if layout.size.height != 40f32 {
        mismatches += 1;
    ...
    if layout.size.width != 70f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node3, stringify!(size.width), 70f32, layout.size.width);
    }
    if layout.size.height != 40f32 {
        mismatches += 1;
