...
fn percentage_flex_basis_cross_max_width__border_box_ltr() {
    ...
    let node0 = taffy
        .new_leaf(taffy::style::Style {
            ...
            max_size: taffy::geometry::Size { width: taffy::style::Dimension::from_percent(0.6f32), height: auto() },
            ..Default::default()
        })
        .unwrap();
    let node1 = taffy
        .new_leaf(taffy::style::Style {
            ...
            max_size: taffy::geometry::Size { width: taffy::style::Dimension::from_percent(0.2f32), height: auto() },
            ..Default::default()
        })
        .unwrap();
    let node = taffy
