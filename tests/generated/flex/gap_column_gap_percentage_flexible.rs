...
fn gap_column_gap_percentage_flexible__border_box() {
    ...
    if layout.location.x != 37f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(location.x), 37f32, layout.location.x);
    }
    if layout.location.y != 0f32 {
        mismatches += 1;
    ...
    if layout.location.x != 73f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(location.x), 73f32, layout.location.x);
    }
    if layout.location.y != 0f32 {
        mismatches += 1;
