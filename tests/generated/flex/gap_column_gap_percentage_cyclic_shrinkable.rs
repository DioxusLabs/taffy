...
fn gap_column_gap_percentage_cyclic_shrinkable__border_box() {
    ...
    if layout.location.x != 24f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(location.x), 24f32, layout.location.x);
    }
    if layout.location.y != 0f32 {
        mismatches += 1;
    ...
    if layout.size.width != 12f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(size.width), 12f32, layout.size.width);
    }
    if layout.size.height != 40f32 {
        mismatches += 1;
    ...
    if layout.location.x != 48f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(location.x), 48f32, layout.location.x);
    }
    if layout.location.y != 0f32 {
        mismatches += 1;
