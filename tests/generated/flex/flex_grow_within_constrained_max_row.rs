...
fn flex_grow_within_constrained_max_row__border_box() {
    ...
    if layout.size.width != 67f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node00, stringify!(size.width), 67f32, layout.size.width);
    }
    if layout.size.height != 100f32 {
        mismatches += 1;
        eprintln!(
    ...
    if layout.size.width != 33f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node01, stringify!(size.width), 33f32, layout.size.width);
    }
    if layout.size.height != 100f32 {
        mismatches += 1;
        eprintln!(
    ...
    if layout.location.x != 67f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node01, stringify!(location.x), 67f32, layout.location.x);
    }
    if layout.location.y != 0f32 {
        mismatches += 1;
