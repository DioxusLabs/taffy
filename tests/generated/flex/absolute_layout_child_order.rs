...
fn absolute_layout_child_order__border_box() {
    ...
    if layout.size.width != 55f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(size.width), 55f32, layout.size.width);
    }
    ...
    if layout.location.x != 25f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(location.x), 25f32, layout.location.x);
    }
    if layout.location.y != 30f32 {
        mismatches += 1;
    ...
    if layout.size.width != 55f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(size.width), 55f32, layout.size.width);
    }
    if layout.size.height != 40f32 {
        mismatches += 1;
    ...
    if layout.location.x != 55f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(location.x), 55f32, layout.location.x);
    }
    if layout.location.y != 30f32 {
        mismatches += 1;
