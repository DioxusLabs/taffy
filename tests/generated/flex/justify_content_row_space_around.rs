...
fn justify_content_row_space_around__border_box() {
    ...
    if layout.location.x != 12f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(location.x), 12f32, layout.location.x);
    }
    if layout.location.y != 0f32 {
        mismatches += 1;
    ...
    if layout.location.x != 78f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(location.x), 78f32, layout.location.x);
    }
    if layout.location.y != 0f32 {
        mismatches += 1;
