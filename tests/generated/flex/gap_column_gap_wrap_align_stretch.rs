...
fn gap_column_gap_wrap_align_stretch__border_box() {
    ...
    if layout.size.width != 71f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(size.width), 71f32, layout.size.width);
    }
    ...
    if layout.size.width != 72f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(size.width), 72f32, layout.size.width);
    }
    if layout.size.height != 150f32 {
        mismatches += 1;
        eprintln!(
    ...
    if layout.location.x != 76f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(location.x), 76f32, layout.location.x);
    }
    if layout.location.y != 0f32 {
        mismatches += 1;
    ...
    if layout.size.width != 71f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(size.width), 71f32, layout.size.width);
    }
    if layout.size.height != 150f32 {
        mismatches += 1;
        eprintln!(
    ...
    if layout.location.x != 153f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(location.x), 153f32, layout.location.x);
    }
    if layout.location.y != 0f32 {
        mismatches += 1;
    ...
    if layout.size.width != 71f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node3, stringify!(size.width), 71f32, layout.size.width);
    }
    if layout.size.height != 150f32 {
        mismatches += 1;
        eprintln!(
    ...
    if layout.location.x != 229f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node3, stringify!(location.x), 229f32, layout.location.x);
    }
    if layout.location.y != 0f32 {
        mismatches += 1;
    ...
    if layout.size.width != 300f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node4, stringify!(size.width), 300f32, layout.size.width);
    }
    if layout.size.height != 150f32 {
        mismatches += 1;
        eprintln!(
    ...
    if layout.location.y != 150f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node4, stringify!(location.y), 150f32, layout.location.y);
    }
    #[cfg(feature = "content_size")]
    if layout.scroll_width() != 0f32 {
        mismatches += 1;
