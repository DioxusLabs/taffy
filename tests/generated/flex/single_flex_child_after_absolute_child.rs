...
fn single_flex_child_after_absolute_child__border_box() {
    ...
    if layout.size.width != 428f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node, stringify!(size.width), 428f32, layout.size.width);
    }
    if layout.size.height != 845f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node, stringify!(size.height), 845f32, layout.size.height);
    }
    ...
    if layout.size.width != 428f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(size.width), 428f32, layout.size.width);
    }
    if layout.size.height != 845f32 {
        mismatches += 1;
        eprintln!(
    ...
    if layout.size.width != 428f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(size.width), 428f32, layout.size.width);
    }
    if layout.size.height != 671f32 {
        mismatches += 1;
        eprintln!(
            "{:?}.{} mismatch: expected {} actual {}",
            node1,
    ...
    if layout.size.width != 428f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(size.width), 428f32, layout.size.width);
    }
    if layout.size.height != 174f32 {
        mismatches += 1;
        eprintln!(
            "{:?}.{} mismatch: expected {} actual {}",
            node2,
    ...
    if layout.location.y != 671f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(location.y), 671f32, layout.location.y);
    }
    #[cfg(feature = "content_size")]
    if layout.scroll_width() != 0f32 {
        mismatches += 1;
