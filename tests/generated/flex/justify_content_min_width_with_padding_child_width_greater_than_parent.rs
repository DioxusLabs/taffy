...
fn justify_content_min_width_with_padding_child_width_greater_than_parent__border_box() {
    ...
    if layout.size.width != 1000f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node, stringify!(size.width), 1000f32, layout.size.width);
    }
    ...
    if layout.size.width != 1000f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(size.width), 1000f32, layout.size.width);
    }
    ...
    if layout.size.width != 500f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node00, stringify!(size.width), 500f32, layout.size.width);
    }
    if layout.size.height != 100f32 {
        mismatches += 1;
        eprintln!(
