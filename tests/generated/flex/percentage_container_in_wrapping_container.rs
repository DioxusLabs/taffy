...
fn percentage_container_in_wrapping_container__border_box() {
    ...
    if layout.size.width != 100f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node00, stringify!(size.width), 100f32, layout.size.width);
    }
    if layout.size.height != 50f32 {
        mismatches += 1;
        eprintln!(
    ...
    if layout.location.x != 50f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node001, stringify!(location.x), 50f32, layout.location.x);
    }
    if layout.location.y != 0f32 {
        mismatches += 1;
