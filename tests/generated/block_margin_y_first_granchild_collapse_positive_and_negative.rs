...
fn block_margin_y_first_granchild_collapse_positive_and_negative() {
    ...
    let node0000 = taffy.new_leaf(taffy::style::Style {
    ...
    let node1000 = taffy.new_leaf(taffy::style::Style {
        size: taffy::geometry::Size { width: auto(), height: taffy::style::Dimension::Length(10f32) },
        ..Default::default()
    });
    let node100 = taffy.new_with_children(
        taffy::style::Style {
            display: taffy::style::Display::Block,
            margin: taffy::geometry::Rect {
                left: zero(),
    ...
    let node2000 = taffy.new_leaf(taffy::style::Style {
        size: taffy::geometry::Size { width: auto(), height: taffy::style::Dimension::Length(10f32) },
        ..Default::default()
    });
    let node200 = taffy.new_with_children(
        taffy::style::Style {
            display: taffy::style::Display::Block,
            margin: taffy::geometry::Rect {
                left: zero(),
    ...
    let node20 = taffy.new_with_children(
        taffy::style::Style {
            display: taffy::style::Display::Block,
            margin: taffy::geometry::Rect {
                left: zero(),
    ...
    let Layout { size, location, .. } = taffy.layout(node1000);
    ...
    let Layout { size, location, .. } = taffy.layout(node200);
    ...
    let Layout { size, location, .. } = taffy.layout(node2000);
