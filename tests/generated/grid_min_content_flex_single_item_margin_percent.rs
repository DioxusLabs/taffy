...
fn grid_min_content_flex_single_item_margin_percent() {
    ...
    assert_eq!(taffy.layout(node1).unwrap().size.height, 38f32);
    assert_eq!(taffy.layout(node1).unwrap().location.x, 42f32);
    assert_eq!(taffy.layout(node1).unwrap().location.y, 1f32);
    ...
    assert_eq!(taffy.layout(node4).unwrap().size.width, 28f32);
    assert_eq!(taffy.layout(node4).unwrap().size.height, 32f32);
    assert_eq!(taffy.layout(node4).unwrap().location.x, 48f32);
    assert_eq!(taffy.layout(node4).unwrap().location.y, 42f32);
    assert_eq!(taffy.layout(node5).unwrap().size.width, 40f32);
    assert_eq!(taffy.layout(node5).unwrap().size.height, 40f32);
    assert_eq!(taffy.layout(node5).unwrap().location.x, 0f32);
    assert_eq!(taffy.layout(node5).unwrap().location.y, 80f32);
    assert_eq!(taffy.layout(node6).unwrap().size.width, 10f32);
    ...
    assert_eq!(taffy.layout(node7).unwrap().size.width, 30f32);
    assert_eq!(taffy.layout(node7).unwrap().size.height, 40f32);
    assert_eq!(taffy.layout(node7).unwrap().location.x, 50f32);
