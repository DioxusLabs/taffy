...
fn grid_gap() {
    ...
    assert_eq!(taffy.layout(node2).unwrap().location.x, 160f32);
    ...
    assert_eq!(taffy.layout(node5).unwrap().location.x, 160f32);
    ...
    assert_eq!(taffy.layout(node6).unwrap().location.y, 160f32);
    ...
    assert_eq!(taffy.layout(node7).unwrap().location.y, 160f32);
    assert_eq!(taffy.layout(node8).unwrap().size.width, 40f32);
    assert_eq!(taffy.layout(node8).unwrap().size.height, 40f32);
    assert_eq!(taffy.layout(node8).unwrap().location.x, 160f32);
    assert_eq!(taffy.layout(node8).unwrap().location.y, 160f32);
}
