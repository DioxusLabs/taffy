...
fn block_absolute_horizontal_right_auto_left_and_width_not_auto__border_box() {
...
#[test]
#[allow(non_snake_case)]
fn block_absolute_horizontal_right_auto_left_and_width_not_auto__content_box() {
    #[allow(unused_imports)]
    use taffy::{prelude::*, Layout};
    let mut taffy = crate::new_test_tree();
    let node0 = taffy
