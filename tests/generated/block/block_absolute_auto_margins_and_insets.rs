...
fn block_absolute_auto_margins_and_insets__border_box() {
    ...
    let node0 = taffy
        .new_leaf_with_context(
            taffy::style::Style {
                ...
                inset: taffy::geometry::Rect { left: length(0f32), right: length(0f32), top: auto(), bottom: auto() },
...
#[test]
#[allow(non_snake_case)]
fn block_absolute_auto_margins_and_insets__content_box() {
    #[allow(unused_imports)]
    use taffy::{prelude::*, Layout};
    let mut taffy = crate::new_test_tree();
    let node0 = taffy
