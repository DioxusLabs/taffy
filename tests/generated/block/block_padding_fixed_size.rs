...
fn block_padding_fixed_size__border_box() {
    ...
    if layout.size.width != 38f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(size.width), 38f32, layout.size.width);
    }
    ...
    if layout.size.width != 38f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(size.width), 38f32, layout.size.width);
    }
    if layout.size.height != 10f32 {
        mismatches += 1;
...
fn block_padding_fixed_size__content_box() {
    ...
    if layout.size.width != 62f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node, stringify!(size.width), 62f32, layout.size.width);
    }
    if layout.size.height != 58f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node, stringify!(size.height), 58f32, layout.size.height);
    }
    if layout.location.x != 0f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node, stringify!(location.x), 0f32, layout.location.x);
