...
fn block_absolute_child_with_margin_y__border_box() {
    ...
    let node1 = taffy
        .new_leaf(taffy::style::Style {
            ...
            margin: taffy::geometry::Rect { left: zero(), right: zero(), top: zero(), bottom: length(7f32) },
            ..Default::default()
        })
        .unwrap();
    let node2 = taffy
        .new_leaf(taffy::style::Style {
            ...
            margin: taffy::geometry::Rect { left: zero(), right: zero(), top: length(10f32), bottom: length(5f32) },
            ..Default::default()
        })
        .unwrap();
    let node = taffy
    ...
    if layout.size.height != 37f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node, stringify!(size.height), 37f32, layout.size.height);
    }
    ...
    if layout.size.width != 9f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(size.width), 9f32, layout.size.width);
    }
    if layout.size.height != 9f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(size.height), 9f32, layout.size.height);
    }
    if layout.location.x != 0f32 {
        mismatches += 1;
    ...
    if layout.location.y != 7f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node0, stringify!(location.y), 7f32, layout.location.y);
    }
    #[cfg(feature = "content_size")]
    if layout.scroll_width() != 0f32 {
        mismatches += 1;
    ...
    if layout.size.width != 9f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(size.width), 9f32, layout.size.width);
    }
    if layout.size.height != 9f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(size.height), 9f32, layout.size.height);
    }
    if layout.location.x != 0f32 {
        mismatches += 1;
    ...
    if layout.size.width != 9f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(size.width), 9f32, layout.size.width);
    }
    if layout.size.height != 9f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node2, stringify!(size.height), 9f32, layout.size.height);
    }
    if layout.location.x != 0f32 {
        mismatches += 1;
