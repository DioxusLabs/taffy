...
fn block_align_baseline_child_padding__border_box() {
    ...
    if layout.location.x != 45f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(location.x), 45f32, layout.location.x);
    }
    ...
    if layout.location.x != 5f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node10, stringify!(location.x), 5f32, layout.location.x);
    }
    if layout.location.y != 5f32 {
        mismatches += 1;
...
fn block_align_baseline_child_padding__content_box() {
    ...
    if layout.size.height != 110f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node, stringify!(size.height), 110f32, layout.size.height);
    }
    if layout.location.x != 0f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node, stringify!(location.x), 0f32, layout.location.x);
