...
fn block_inset_direction_rtl__border_box_ltr() {
    ...
    let node0 = taffy
        .new_leaf(taffy::style::Style {
            ...
            inset: taffy::geometry::Rect { left: length(10f32), right: auto(), top: auto(), bottom: auto() },
            ..Default::default()
        })
        .unwrap();
    let node1 = taffy
        .new_leaf(taffy::style::Style {
            ...
            inset: taffy::geometry::Rect { left: auto(), right: length(10f32), top: auto(), bottom: auto() },
            ..Default::default()
        })
        .unwrap();
    let node = taffy
