...
fn block_margin_x_intrinsic_size_positive__border_box() {
    ...
    if layout.size.width != 15f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node, stringify!(size.width), 15f32, layout.size.width);
    }
    ...
    if layout.size.width != 15f32 {
        mismatches += 1;
        eprintln!("{:?}.{} mismatch: expected {} actual {}", node1, stringify!(size.width), 15f32, layout.size.width);
    }
    if layout.size.height != 10f32 {
        mismatches += 1;
