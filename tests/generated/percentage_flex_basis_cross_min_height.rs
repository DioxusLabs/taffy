...
fn percentage_flex_basis_cross_min_height() {
    ...
    let node0 = taffy.new_with_children(
        taffy::style::FlexboxLayout {
            flex_grow: 1f32,
            min_size: taffy::geometry::Size { height: taffy::style::Dimension::Percent(0.6f32), ..Default::default() },
            ..Default::default()
        },
        &[],
    );
    let node1 = taffy.new_with_children(
        taffy::style::FlexboxLayout {
            flex_grow: 2f32,
            min_size: taffy::geometry::Size { height: taffy::style::Dimension::Percent(0.1f32), ..Default::default() },
            ..Default::default()
        },
        &[],
    );
