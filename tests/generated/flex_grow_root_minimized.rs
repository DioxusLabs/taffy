...
fn flex_grow_root_minimized() {
    ...
    assert_eq!(stretch.layout(node).size.height, 300f32);
    assert_eq!(stretch.layout(node).location.x, 0f32);
    assert_eq!(stretch.layout(node).location.y, 0f32);
    assert_eq!(stretch.layout(node0).size.width, 100f32);
    assert_eq!(stretch.layout(node0).size.height, 300f32);
    ...
    assert_eq!(stretch.layout(node00).size.height, 200f32);
    ...
    assert_eq!(stretch.layout(node01).location.y, 200f32);
}
