...
fn align_self_center_undefined_max_height() {
    ...
    assert_eq!(size.width, 280f32, "width of node {:?}. Expected {}. Actual {}", node.data(), 280f32, size.width);
    assert_eq!(size.height, 56f32, "height of node {:?}. Expected {}. Actual {}", node.data(), 56f32, size.height);
    assert_eq!(location.x, 0f32, "x of node {:?}. Expected {}. Actual {}", node.data(), 0f32, location.x);
    assert_eq!(location.y, 0f32, "y of node {:?}. Expected {}. Actual {}", node.data(), 0f32, location.y);
    let Layout { size, location, .. } = taffy.layout(node0).unwrap();
    assert_eq!(size.width, 240f32, "width of node {:?}. Expected {}. Actual {}", node0.data(), 240f32, size.width);
    ...
    assert_eq!(size.height, 56f32, "height of node {:?}. Expected {}. Actual {}", node1.data(), 56f32, size.height);
    assert_eq!(location.x, 240f32, "x of node {:?}. Expected {}. Actual {}", node1.data(), 240f32, location.x);
