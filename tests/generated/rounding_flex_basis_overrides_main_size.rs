...
fn rounding_flex_basis_overrides_main_size() {
    ...
    let node = stretch.new_node(
        stretch::style::Style {
            ...
            size: stretch::geometry::Size {
                ...
                height: stretch::style::Dimension::Points(113f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    assert_eq!(stretch.layout(node0).size.height, 64f32);
    ...
    assert_eq!(stretch.layout(node1).size.height, 25f32);
    assert_eq!(stretch.layout(node1).location.x, 0f32);
    assert_eq!(stretch.layout(node1).location.y, 64f32);
