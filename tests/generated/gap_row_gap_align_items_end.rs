...
fn gap_row_gap_align_items_end() {
    ...
    assert_eq!(taffy.layout(node2).unwrap().size.height, 0f32);
    ...
    assert_eq!(taffy.layout(node3).unwrap().location.y, 200f32);
    ...
    assert_eq!(taffy.layout(node4).unwrap().location.y, 200f32);
    ...
    assert_eq!(taffy.layout(node5).unwrap().location.y, 200f32);
}
