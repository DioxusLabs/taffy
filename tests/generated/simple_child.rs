...
fn simple_child() {
    ...
    assert_eq!(size.width, 10f32, "width of node {:?}. Expected {}. Actual {}", node00.data(), 10f32, size.width);
    ...
    assert_eq!(size.width, 10f32, "width of node {:?}. Expected {}. Actual {}", node000.data(), 10f32, size.width);
    ...
    assert_eq!(location.x, 10f32, "x of node {:?}. Expected {}. Actual {}", node01.data(), 10f32, location.x);
    ...
    assert_eq!(size.width, 10f32, "width of node {:?}. Expected {}. Actual {}", node010.data(), 10f32, size.width);
    assert_eq!(size.height, 10f32, "height of node {:?}. Expected {}. Actual {}", node010.data(), 10f32, size.height);
    assert_eq!(location.x, 0f32, "x of node {:?}. Expected {}. Actual {}", node010.data(), 0f32, location.x);
    assert_eq!(location.y, 45f32, "y of node {:?}. Expected {}. Actual {}", node010.data(), 45f32, location.y);
    let Layout { size, location, .. } = taffy.layout(node011).unwrap();
    assert_eq!(size.width, 10f32, "width of node {:?}. Expected {}. Actual {}", node011.data(), 10f32, size.width);
    assert_eq!(size.height, 10f32, "height of node {:?}. Expected {}. Actual {}", node011.data(), 10f32, size.height);
    assert_eq!(location.x, 10f32, "x of node {:?}. Expected {}. Actual {}", node011.data(), 10f32, location.x);
    assert_eq!(location.y, 45f32, "y of node {:?}. Expected {}. Actual {}", node011.data(), 45f32, location.y);
}
