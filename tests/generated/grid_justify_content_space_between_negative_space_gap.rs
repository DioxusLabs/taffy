#[test]
fn grid_justify_content_space_between_negative_space_gap() {
    use slotmap::Key;
    ...
    assert_eq!(location.x, 100f32, "x of node {:?}. Expected {}. Actual {}", node02.data(), 100f32, location.x);
    ...
    assert_eq!(location.x, 0f32, "x of node {:?}. Expected {}. Actual {}", node03.data(), 0f32, location.x);
    ...
    assert_eq!(location.x, 100f32, "x of node {:?}. Expected {}. Actual {}", node05.data(), 100f32, location.x);
    ...
    assert_eq!(location.x, 0f32, "x of node {:?}. Expected {}. Actual {}", node06.data(), 0f32, location.x);
    ...
    assert_eq!(location.x, 100f32, "x of node {:?}. Expected {}. Actual {}", node08.data(), 100f32, location.x);
