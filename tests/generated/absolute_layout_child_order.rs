...
fn absolute_layout_child_order() {
    ...
    assert_eq!(stretch.layout(node0).size.width, 55f32);
    ...
    assert_eq!(stretch.layout(node1).size.width, 60f32);
    assert_eq!(stretch.layout(node1).size.height, 40f32);
    assert_eq!(stretch.layout(node1).location.x, 25f32);
    assert_eq!(stretch.layout(node1).location.y, 30f32);
    assert_eq!(stretch.layout(node2).size.width, 55f32);
    assert_eq!(stretch.layout(node2).size.height, 40f32);
    assert_eq!(stretch.layout(node2).location.x, 55f32);
