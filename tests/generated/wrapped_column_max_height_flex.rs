...
fn wrapped_column_max_height_flex() {
    ...
    assert_eq!(stretch.layout(node0).location.x, 300f32);
    assert_eq!(stretch.layout(node0).location.y, 0f32);
    assert_eq!(stretch.layout(node1).size.width, 200f32);
    assert_eq!(stretch.layout(node1).size.height, 180f32);
    assert_eq!(stretch.layout(node1).location.x, 250f32);
    assert_eq!(stretch.layout(node1).location.y, 200f32);
    assert_eq!(stretch.layout(node2).size.width, 100f32);
    assert_eq!(stretch.layout(node2).size.height, 100f32);
    assert_eq!(stretch.layout(node2).location.x, 300f32);
    assert_eq!(stretch.layout(node2).location.y, 400f32);
}
