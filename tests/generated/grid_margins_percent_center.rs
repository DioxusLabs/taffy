#[test]
fn grid_margins_percent_center() {
    use slotmap::Key;
    ...
    assert_eq!(location.x, 1f32, "x of node {:?}. Expected {}. Actual {}", node0.data(), 1f32, location.x);
    assert_eq!(location.y, 9f32, "y of node {:?}. Expected {}. Actual {}", node0.data(), 9f32, location.y);
