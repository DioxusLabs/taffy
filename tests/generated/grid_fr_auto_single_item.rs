...
fn grid_fr_auto_single_item() {
    ...
    println!();
    assert_eq!(taffy.layout(node).unwrap().size.width, 240f32);
    ...
    assert_eq!(taffy.layout(node2).unwrap().location.x, 140f32);
    assert_eq!(taffy.layout(node2).unwrap().location.y, 0f32);
    assert_eq!(taffy.layout(node3).unwrap().size.width, 40f32);
    assert_eq!(taffy.layout(node3).unwrap().size.height, 0f32);
    assert_eq!(taffy.layout(node3).unwrap().location.x, 0f32);
    assert_eq!(taffy.layout(node3).unwrap().location.y, 40f32);
    assert_eq!(taffy.layout(node4).unwrap().size.width, 100f32);
    assert_eq!(taffy.layout(node4).unwrap().size.height, 0f32);
    assert_eq!(taffy.layout(node4).unwrap().location.x, 40f32);
    assert_eq!(taffy.layout(node4).unwrap().location.y, 40f32);
    assert_eq!(taffy.layout(node5).unwrap().size.width, 100f32);
    assert_eq!(taffy.layout(node5).unwrap().size.height, 0f32);
    assert_eq!(taffy.layout(node5).unwrap().location.x, 140f32);
    assert_eq!(taffy.layout(node5).unwrap().location.y, 40f32);
    assert_eq!(taffy.layout(node6).unwrap().size.width, 40f32);
    assert_eq!(taffy.layout(node6).unwrap().size.height, 0f32);
    assert_eq!(taffy.layout(node6).unwrap().location.x, 0f32);
    assert_eq!(taffy.layout(node6).unwrap().location.y, 40f32);
    assert_eq!(taffy.layout(node7).unwrap().size.width, 100f32);
    assert_eq!(taffy.layout(node7).unwrap().size.height, 0f32);
    assert_eq!(taffy.layout(node7).unwrap().location.x, 40f32);
    assert_eq!(taffy.layout(node7).unwrap().location.y, 40f32);
    assert_eq!(taffy.layout(node8).unwrap().size.width, 100f32);
    assert_eq!(taffy.layout(node8).unwrap().size.height, 0f32);
    assert_eq!(taffy.layout(node8).unwrap().location.x, 140f32);
