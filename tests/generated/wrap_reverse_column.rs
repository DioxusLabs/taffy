...
fn wrap_reverse_column() {
    ...
    assert_eq!(stretch.layout(node0).location.x, 70f32);
    ...
    assert_eq!(stretch.layout(node1).location.x, 70f32);
    ...
    assert_eq!(stretch.layout(node2).location.x, 70f32);
    ...
    assert_eq!(stretch.layout(node3).location.x, 20f32);
