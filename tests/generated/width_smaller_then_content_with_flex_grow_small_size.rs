...
fn width_smaller_then_content_with_flex_grow_small_size() {
    ...
    assert_eq!(stretch.layout(node).size.width, 10f32);
    assert_eq!(stretch.layout(node).size.height, 100f32);
    assert_eq!(stretch.layout(node).location.x, 0f32);
    assert_eq!(stretch.layout(node).location.y, 0f32);
    assert_eq!(stretch.layout(node0).size.width, 5f32);
    ...
    assert_eq!(stretch.layout(node1).size.width, 5f32);
    assert_eq!(stretch.layout(node1).size.height, 100f32);
    assert_eq!(stretch.layout(node1).location.x, 5f32);
