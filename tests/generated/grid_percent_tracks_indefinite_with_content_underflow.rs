...
fn grid_percent_tracks_indefinite_with_content_underflow() {
    ...
    assert_eq!(location.x, 10f32, "x of node {:?}. Expected {}. Actual {}", node5.data(), 10f32, location.x);
    ...
    assert_eq!(size.width, 30f32, "width of node {:?}. Expected {}. Actual {}", node6.data(), 30f32, size.width);
    assert_eq!(size.height, 60f32, "height of node {:?}. Expected {}. Actual {}", node6.data(), 60f32, size.height);
    assert_eq!(location.x, 30f32, "x of node {:?}. Expected {}. Actual {}", node6.data(), 30f32, location.x);
    assert_eq!(location.y, 30f32, "y of node {:?}. Expected {}. Actual {}", node6.data(), 30f32, location.y);
}
