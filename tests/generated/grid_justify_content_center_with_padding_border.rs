...
fn grid_justify_content_center_with_padding_border() {
    ...
    assert_eq!(taffy.layout(node0).unwrap().location.x, 52f32);
    ...
    assert_eq!(taffy.layout(node1).unwrap().location.x, 92f32);
    ...
    assert_eq!(taffy.layout(node2).unwrap().location.x, 132f32);
    ...
    assert_eq!(taffy.layout(node3).unwrap().location.x, 52f32);
    ...
    assert_eq!(taffy.layout(node4).unwrap().location.x, 92f32);
    ...
    assert_eq!(taffy.layout(node5).unwrap().location.x, 132f32);
    ...
    assert_eq!(taffy.layout(node6).unwrap().location.x, 52f32);
    ...
    assert_eq!(taffy.layout(node7).unwrap().location.x, 92f32);
    ...
    assert_eq!(taffy.layout(node8).unwrap().location.x, 132f32);
