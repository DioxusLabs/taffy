...
fn align_items_stretch_min_cross() {
    ...
    assert_eq!(size.width, 400f32, "width of node {:?}. Expected {}. Actual {}", node0.data(), 400f32, size.width);
    assert_eq!(size.height, 36f32, "height of node {:?}. Expected {}. Actual {}", node0.data(), 36f32, size.height);
