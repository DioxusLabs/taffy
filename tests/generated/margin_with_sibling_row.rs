...
fn margin_with_sibling_row() {
    ...
    assert_eq!(size.width, 45f32, "width of node {:?}. Expected {}. Actual {}", node0.data(), 45f32, size.width);
    ...
    assert_eq!(size.width, 45f32, "width of node {:?}. Expected {}. Actual {}", node1.data(), 45f32, size.width);
