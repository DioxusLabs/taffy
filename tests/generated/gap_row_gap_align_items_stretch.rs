...
fn gap_row_gap_align_items_stretch() {
    ...
    assert_eq!(taffy.layout(node1).unwrap().size.height, 90f32);
    ...
    assert_eq!(taffy.layout(node2).unwrap().size.height, 90f32);
    ...
    assert_eq!(taffy.layout(node3).unwrap().size.height, 90f32);
    assert_eq!(taffy.layout(node3).unwrap().location.x, 0f32);
    assert_eq!(taffy.layout(node3).unwrap().location.y, 110f32);
    assert_eq!(taffy.layout(node4).unwrap().size.width, 20f32);
    assert_eq!(taffy.layout(node4).unwrap().size.height, 90f32);
    assert_eq!(taffy.layout(node4).unwrap().location.x, 30f32);
    assert_eq!(taffy.layout(node4).unwrap().location.y, 110f32);
    assert_eq!(taffy.layout(node5).unwrap().size.width, 20f32);
    assert_eq!(taffy.layout(node5).unwrap().size.height, 90f32);
    assert_eq!(taffy.layout(node5).unwrap().location.x, 60f32);
    assert_eq!(taffy.layout(node5).unwrap().location.y, 110f32);
}
