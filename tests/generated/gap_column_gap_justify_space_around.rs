#[test]
fn gap_column_gap_justify_space_around() {
    use slotmap::Key;
    ...
    assert_eq!(location.x, 3f32, "x of node {:?}. Expected {}. Actual {}", node0.data(), 3f32, location.x);
    ...
    assert_eq!(location.x, 77f32, "x of node {:?}. Expected {}. Actual {}", node2.data(), 77f32, location.x);
