...
mod aspect_ratio_flex_leaf_fill_height;
mod aspect_ratio_flex_leaf_fill_max_height;
mod aspect_ratio_flex_leaf_fill_max_width;
mod aspect_ratio_flex_leaf_fill_min_height;
mod aspect_ratio_flex_leaf_fill_min_width;
mod aspect_ratio_flex_leaf_fill_width;
mod aspect_ratio_flex_leaf_fill_width_flex;
...
fn benchmark(c: &mut Criterion) {
    c.bench_function("generated benchmarks", |b| {
        b.iter(|| {
            ...
            aspect_ratio_flex_leaf_fill_height::compute();
            aspect_ratio_flex_leaf_fill_max_height::compute();
            aspect_ratio_flex_leaf_fill_max_width::compute();
            aspect_ratio_flex_leaf_fill_min_height::compute();
            aspect_ratio_flex_leaf_fill_min_width::compute();
            aspect_ratio_flex_leaf_fill_width::compute();
            aspect_ratio_flex_leaf_fill_width_flex::compute();
