...
fn benchmark(c: &mut Criterion) {
    c.bench_function("generated benchmarks", |b| {
        b.iter(|| {
            ...
            absolute_aspect_ratio_width_overrides_inset::compute();
            absolute_child_with_cross_margin::compute();
            absolute_child_with_main_margin::compute();
            absolute_child_with_max_height::compute();
            absolute_child_with_max_height_larger_shrinkable_grandchild::compute();
            ...
            absolute_minmax_bottom_right_max::compute();
            absolute_minmax_bottom_right_min_max::compute();
            absolute_minmax_bottom_right_min_max_preferred::compute();
            absolute_minmax_top_left_bottom_right_max::compute();
            ...
            align_content_flex_end::compute();
            align_content_flex_start::compute();
            align_content_flex_start_with_flex::compute();
            align_content_flex_start_without_height_on_children::compute();
            align_content_not_stretch_with_align_items_stretch::compute();
            ...
            align_content_spacearound::compute();
            align_content_spacebetween::compute();
            align_content_stretch::compute();
            align_content_stretch_column::compute();
            align_content_stretch_is_not_overriding_align_items::compute();
            align_content_stretch_row::compute();
            align_content_stretch_row_with_children::compute();
            align_content_stretch_row_with_fixed_height::compute();
            align_content_stretch_row_with_flex::compute();
            align_content_stretch_row_with_flex_no_shrink::compute();
            align_content_stretch_row_with_margin::compute();
            align_content_stretch_row_with_max_height::compute();
            align_content_stretch_row_with_min_height::compute();
            align_content_stretch_row_with_padding::compute();
            align_content_stretch_row_with_single_row::compute();
            ...
            align_items_center_justify_content_center::compute();
            align_items_center_min_max_with_padding::compute();
            ...
            align_items_stretch_min_cross::compute();
            align_self_baseline::compute();
            align_self_center::compute();
            align_self_center_undefined_max_height::compute();
            ...
            flex_direction_column_reverse_no_height::compute();
            ...
            gap_column_gap_row_gap_wrapping::compute();
            ...
            #[cfg(feature = "grid")]
            grid_absolute_layout_within_border_static::compute();
            #[cfg(feature = "grid")]
            ...
            #[cfg(feature = "grid")]
            grid_minmax_auto_fixed_10px::compute();
            #[cfg(feature = "grid")]
            grid_minmax_auto_max_content::compute();
            #[cfg(feature = "grid")]
            grid_minmax_auto_min_content::compute();
            #[cfg(feature = "grid")]
            grid_minmax_auto_percent_definite::compute();
            #[cfg(feature = "grid")]
            grid_minmax_auto_percent_indefinite::compute();
            #[cfg(feature = "grid")]
            grid_minmax_column_fixed_width_above_range::compute();
            #[cfg(feature = "grid")]
            grid_minmax_column_fixed_width_below_range::compute();
            #[cfg(feature = "grid")]
            grid_minmax_column_fixed_width_within_range::compute();
            #[cfg(feature = "grid")]
            grid_minmax_column_indefinite::compute();
            #[cfg(feature = "grid")]
            grid_minmax_column_with_auto_fixed::compute();
            #[cfg(feature = "grid")]
            grid_minmax_column_with_fr_fixed::compute();
            #[cfg(feature = "grid")]
            grid_minmax_max_content_1fr::compute();
            #[cfg(feature = "grid")]
            grid_minmax_max_content_auto::compute();
            #[cfg(feature = "grid")]
            grid_minmax_max_content_fixed_10px::compute();
            #[cfg(feature = "grid")]
            grid_minmax_max_content_min_content::compute();
            #[cfg(feature = "grid")]
            grid_minmax_max_content_percent_definite::compute();
            #[cfg(feature = "grid")]
            grid_minmax_max_content_percent_indefinite::compute();
            #[cfg(feature = "grid")]
            grid_minmax_min_content_1fr::compute();
            #[cfg(feature = "grid")]
            grid_minmax_min_content_auto::compute();
            #[cfg(feature = "grid")]
            grid_minmax_min_content_fixed_10px::compute();
            #[cfg(feature = "grid")]
            grid_minmax_min_content_max_content::compute();
            #[cfg(feature = "grid")]
            grid_minmax_min_content_percent_definite::compute();
            #[cfg(feature = "grid")]
            ...
            #[cfg(feature = "grid")]
            grid_span_2_min_content_auto_indefinite::compute();
            #[cfg(feature = "grid")]
            grid_span_2_min_content_fit_content_10px_indefinite::compute();
            #[cfg(feature = "grid")]
            grid_span_2_min_content_fit_content_30px_indefinite::compute();
            #[cfg(feature = "grid")]
            grid_span_2_min_content_fit_content_80px_indefinite::compute();
            #[cfg(feature = "grid")]
            ...
            intrinsic_sizing_main_size_column_wrap::compute();
            intrinsic_sizing_main_size_row::compute();
            intrinsic_sizing_main_size_row_nested::compute();
            intrinsic_sizing_main_size_row_wrap::compute();
            justify_content_column_center::compute();
            justify_content_column_flex_end::compute();
            justify_content_column_flex_start::compute();
            justify_content_column_max_height_and_margin::compute();
            ...
            min_height::compute();
            min_height_larger_than_height::compute();
            min_height_overrides_height::compute();
            min_height_overrides_height_on_root::compute();
            min_height_overrides_max_height::compute();
            min_height_with_nested_fixed_height::compute();
            min_max_percent_different_width_height::compute();
            min_max_percent_no_width_height::compute();
            min_width::compute();
            min_width_larger_than_width::compute();
            ...
            percentage_different_width_height::compute();
            percentage_different_width_height_column::compute();
            ...
            undefined_height_with_min_max::compute();
            undefined_width_with_min_max::compute();
            undefined_width_with_min_max_row::compute();
